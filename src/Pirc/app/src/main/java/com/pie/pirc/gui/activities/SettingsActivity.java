...
public class SettingsActivity extends PreferenceActivity
{
    ...
    private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener =
        new OnPreferenceChangedListenerHandler();

    /***************************************************************************************************************//**
     * Overridden PreferenceActivity methods.
     ******************************************************************************************************************/
    ...
    private void setupSimplePreferencesScreen()
    {
        ...
        fakeHeader.setTitle(R.string.pref_header_audio);
        getPreferenceScreen().addPreference(fakeHeader);
        addPreferencesFromResource(R.xml.pref_audio);

        // Add 'video' preferences, and a corresponding header.
        fakeHeader = new PreferenceCategory(this);
        fakeHeader.setTitle(R.string.pref_header_video);
        getPreferenceScreen().addPreference(fakeHeader);
        ...
        bindPreferenceSummaryToValue(findPreference(Settings.AUDIO_PREFERRED_AUDIO_OUTPUT));
        bindPreferenceSummaryToValue(findPreference(Settings.CONNECTION_ADDRESS));
        bindPreferenceSummaryToValue(findPreference(Settings.CONNECTION_PROTOCOL));
        bindPreferenceSummaryToValue(findPreference(Settings.GENERAL_UI_LANGUAGE));
        bindPreferenceSummaryToValue(findPreference(Settings.VIDEO_PREFERRED_AUDIO_OUTPUT));
        bindPreferenceSummaryToValue(findPreference(Settings.VIDEO_PREFERRED_LANGUAGE));
        bindPreferenceSummaryToValue(findPreference(Settings.VIDEO_PREFERRED_SUBTITLE_LANGUAGE));
    }
    ...
    private static class OnPreferenceChangedListenerHandler implements Preference.OnPreferenceChangeListener
    {
        @Override
    ...
    /**
     * This fragment shows video preferences only. It is used when the activity is showing a two-pane settings UI.
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class AudioPreferenceFragment extends PreferenceFragment
    {
        ...
        public void onCreate(Bundle savedInstanceState)
        {
            ...
            bindPreferenceSummaryToValue(findPreference("pref_description_audio_preferred_audio_output"));
        }
    }

    /**
     * This fragment shows connection preferences only. It is used when the activity is showing a two-pane settings UI.
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class ConnectionPreferenceFragment extends PreferenceFragment
    {
        ...
        public void onCreate(Bundle savedInstanceState)
        {
            ...
            // Bind the summaries of EditText/List/Dialog/Ringtone preferences to their values. When their values
            // change, their summaries are updated to reflect the new value, per the Android Design guidelines.
            bindPreferenceSummaryToValue(findPreference("pref_description_connection_address"));
            bindPreferenceSummaryToValue(findPreference("pref_description_connection_protocol"));
        }
    }
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment
    {
        ...
        public void onCreate(Bundle savedInstanceState)
        {
            ...
            // Bind the summaries of EditText/List/Dialog/Ringtone preferences to their values. When their values
            // change, their summaries are updated to reflect the new value, per the Android Design guidelines.
            bindPreferenceSummaryToValue(findPreference("pref_description_general_ui_language"));
        }
    }
    ...
    public static class VideoPreferenceFragment extends PreferenceFragment
    {
        ...
        public void onCreate(Bundle savedInstanceState)
        {
            ...
            // Bind the summaries of EditText/List/Dialog/Ringtone preferences to their values. When their values
            // change, their summaries are updated to reflect the new value, per the Android Design guidelines.
            bindPreferenceSummaryToValue(findPreference("pref_description_video_preferred_audio_output"));
            bindPreferenceSummaryToValue(findPreference("pref_description_video_preferred_language"));
            bindPreferenceSummaryToValue(findPreference("pref_description_video_preferred_subtitle_language"));
        }
    }
}
